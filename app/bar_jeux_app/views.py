...
def _final_page(user):
    ...
    #liste_game_preter = [ObjectId('9e705c422573f38168868b69'), ObjectId('2d8b89f7e9d1d3de59c75edf')]
    ...
    liste_pret_user_detail["Nouveauté"] = "Nouvauté" ##liste_pret_user_detail.apply(nouveaute_def(row), axis=1)
