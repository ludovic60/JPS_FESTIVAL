        ...
        with c2:
            ...
            with cc[0]:
                ...
                if is_admin and mode != "suggestion":
                    ...
                    with  col1  :
                          if st.button(   "✅ valider la suggestion", key=f"valid_sug_{ckey_this_game}", use_container_width=True, width="content",  wrap=True) :
                    ...
                    with  col2  :
                          if st.button(  "❌ refuser la suggestion" ,  key=f"refuse_sug_{ckey_this_game}",use_container_width=True, width="content",  wrap=True) :
